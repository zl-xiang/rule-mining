...
#eqo(V0,V1):- att(V2,id,V0),cora(V2),att(V2,editor,V4),att(V2,journal,V5),att(V3,journal,V7),
     #   att(V3,editor,V6),cora(V3),att(V3,id,V1),sim(V6,V4,S0), S0>=85,sim(V7,V5,S1), S1>=95
# eqo(V0,V1):- att(V2,id,V0),cora(V2),att(V2,editor,V4),att(V2,journal,V5),att(V3,journal,V7),


#s ---- eqo(V0,V1):- att(V2,address,V5),sim(V6,V5,95),sim(V4,V7,85),att(V2,journal,V4),cora(V3),att(V3,id,V1),cora(V2),att(V2,id,V0),att(V3,address,V6),att(V3,journal,V7).
#s ---- eqo(V0,V1):- att(V2,address,V5),sim(V6,V5,90),att(V2,journal,V4),cora(V3),att(V3,journal,V4),att(V3,id,V1),cora(V2),att(V2,id,V0),att(V3,address,V6).
#   att(V3,editor,V6),cora(V3),att(V3,id,V1),sim(V5,V7,S0), S0>=85,sim(V6,V4,S1), S1>=85.

# eqo(V0,V1):- att(V2,id,V0),cora(V2),att(V2,editor,V5),att(V2,institution,V4),att(V3,editor,V5),att(V3,institution,V6),att(V3,id,V1),cora(V3),sim(V4,V6,S0), S0>=85
# eqo(V0,V1):- att(V2,id,V0),cora(V2),att(V2,editor,V4),att(V2,institution,V5),att(V3,institution,V5),att(V3,editor,V4),att(V3,id,V1),cora(V3).
    # head
    h1 = Literal('eqo', (0, 1))
    h2 = Literal('eqo', (0, 1))
    ...
    b1 = {
        ...
        Literal('att', (2, 'id', 0)),
        Literal('att', (3, 'id', 1)),
        Literal('att', (2, 'editor', 5)),
        Literal('att', (3, 'editor', 5)),
        Literal('att', (2, 'institution', 4)),
        Literal('att', (3, 'institution', 6)),
        Literal('sim', (4,6,85)),
        # join on rid
    }
    ...
    b2 = {
        ...
        Literal('att', (2, 'id', 0)),
        Literal('att', (3, 'id', 1)),
        Literal('att', (2, 'editor', 4)),
        Literal('att', (3, 'editor', 4)),
        Literal('att', (2, 'institution', 5)),
        Literal('att', (3, 'institution', 5)),
...
#   title_basics(V2),att(V2,genres,V5),att(V3,tconst,V1),att(V4,tconst,V1),att(V3,genres,V5),title_principals(V4),title_basics(V3),att(V2,tconst,V0).
    ...
    range_pair = (('cora', 'id'), ('cora', 'id'))
    result = rule_subsume_trc(r1,r1, range_pair)
