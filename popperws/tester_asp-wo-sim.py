...
from . util import order_prog, prog_is_recursive, rule_is_recursive, calc_rule_size, calc_prog_size, prog_hash, format_rule, format_literal, Literal, is_int, reorder_body, format_prog, format_rule_symmetry_breaking
...
class Tester():
    ...
    def test_prog_all(self, prog):
        ...
        solver .add('base', [], "sim(X,X):- sim(X,_).\n"+"sim(X,Y):- sim(Y,X).")
        solver.ground(((('base',[])),))
