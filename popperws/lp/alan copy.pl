...
{body_literal(0,R,1,Tid)}:- body_literal(0,R1,1,Tid1), has_sort(R1,Attr1), has_sort(R,Attr2), compatible_attr(Attr1,Attr2), vars(3,Vars), var_pos(Tid,Vars,0), Tid!=Tid1, not pairwise.
...
:-  body_literal(0,R1,1,Tid1), #count{Attr,Var:body_literal(0,att,3,(Tid1,Attr,Var))}<1.
