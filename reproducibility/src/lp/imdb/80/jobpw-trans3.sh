...
do
    ...
    python /home/zhiliangxiang/Academic/project/rule-mining/rule-mining/popper.py --deduce-sim -fp "$theta" -d "$delta" ./s${s}pw \
        > "$raw_log" 2>&1
    ...
    era_output_dir="${era_base_dir}/experiment/trc-rule/${dataset}/${split}/s${s}pw"
    echo "${era_output_dir}"
