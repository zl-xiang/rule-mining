...
score_file="$base_dir/scores/${dataset}-${split}-s${sample}-scores-v2.csv"
...
do
    ...
    do
        ...
        raw_log="$base_dir/logs/${run_name}2.log"
        ...
        python /home/zhiliangxiang/Academic/project/rule-mining/rule-mining/popper.py --deduce-sim -fp "$theta" -d "$delta" ./s${s}/v${v} \
            > "$raw_log" 2>&1
        ...
        era_log="${era_output_dir}/${run_name}2.log"
